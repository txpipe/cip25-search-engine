            ...
            <div className="max-w-7xl mx-auto h-full">
                <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20  lg:w-full lg:pb-28 xl:pb-32 h-full">
                    <main className="mt-10 mx-auto px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28 h-full">
                        <div className="flex flex-col md:flex-row w-full items-center justify-between md:justify-start h-full md:h-1/2">
                            <div className="text-left z-20 md:z-30 w-full md:w-1/2 flex flex-col items-center md:items-start justify-center h-full">
                                ...
                                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start w-full">
                                    <div className="rounded-md shadow">
                                        <a className="w-full flex items-center justify-center px-8 py-3  text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 px-4 py-2" href="/search">
                                            Search Tokens
                                        </a>
                                    </div>
                                    <div className="mt-3 sm:mt-0 sm:ml-3">
                                        <a target="_blank" rel="noreferrer" href="https://github.com/txpipe/cip25-search-engine" className="w-full flex items-center justify-center px-8 py-3  text-base font-medium rounded-md text-gray-800 bg-gray-100 hover:bg-gray-200 px-4 py-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="ml-2" viewBox="0 0 1792 1792">
                                ...
                                <div className="mt-4 text-gray-500">
                                    <h3 className="text-xl">Need help implementing Oura?</h3>
                                    <ul>
                                        <li>submit a <a className="underline" href="aaa">Github issue</a></li>
                                        <li><a className="underline" href="aaa">read Oura documentation</a></li>
                                        <li><a className="underline" href="aaa">check Oura source code</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="opacity-10 z-10 md:z-50 md:opacity-30 sm:text-center absolute lg:text-left transform  w-full -right-10 -top-72  md:w-1/2">
